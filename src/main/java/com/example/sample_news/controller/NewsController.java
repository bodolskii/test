package com.example.sample_news.controller;

import com.example.sample_news.service.NewsService;
...
@Log4j2
@WebServlet("*.news")
//뉴스 이미지 파일 업로드 처리를 위해 @MultipartConfig 을 추가
//최대 파일크기와 저장 위치 지정
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (action){
            ...
            case "add" :
                ...
                resp.sendRedirect("lsit.news?action=list");
                break;
            case "remove":
