    ...
    <ul class="list-group">
        <c:forEach var="news" items="${newsList}" varStatus="status">
            <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                <a href="view.news?action=view&aid=${news.aid}" class="text-decoration-none">
                    [${status.count}] ${news.title}, ${news.date}</a>
                <a href="./remove.news?action=remove&aid=${news.aid}">
    ...
    <div class="collapse" id="addForm">
        <div class="card card-body">
            <form method="post" action="./add.news?action=add" enctype="multipart/form-data">
                ...
                <label class="form-label">진 </label>
                <input type="date" name="deletDate" class="form-control">
